...
class AnnouncementRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'category' => ['nullable', 'in:general,academic,event,emergency,policy,exam,holiday'],
            'target_audience' => ['nullable', 'in:everyone,students,faculty,staff,specific_course,specific_faculty'],
    ...
    public function messages(): array
    {
        return [
            ...
            'category.in' => 'The category must be one of: general, academic, event, emergency, policy, exam, holiday.',
            'target_audience.in' => 'The target audience must be one of: everyone, students, faculty, staff, specific_course, specific_faculty.',
